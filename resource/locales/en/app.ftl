...
welcome_title = Welcome to Games Fair
welcome_body =
    This is **Games Fair**, an [App Fair](https://appfair.org) app: free software, built from source you can read, and distributed through the App Fair Project.
